"""
Demo 05d: Visualize sentence embeddings with t-SNE (1536D → 2D).
Similar-meaning sentences cluster together in 2D space.
Run: python 05d_embeddings_tsne_viz.py
Depends: pip install openai numpy scikit-learn matplotlib
